...
## Description
一个自开发适用于全平台的QQ机器人，用于使用HTTP协议对接符合OneBot协议，并进行自动处理的python程序，主要用于自用，此项目更偏向于个人学习和使用，自带指令系统以及简单的程序接口，适合上手，通讯部分依照[NapCatQQ API](https://napcat.apifox.cn/)进行操作使用和扩展。
